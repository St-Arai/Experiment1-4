...
<<<<<<< HEAD
  ...
  public String toString() {
    return "OEmbedRequest{" + "statusId=" + statusId + ", url='" + url + '\'' + ", maxWidth="
        + maxWidth + ", hideMedia=" + hideMedia + ", hideThread=" + hideThread + ", omitScript="
        + omitScript + ", align=" + align + ", related="
        + (related == null ? null : Arrays.asList(related)) + ", lang='" + lang + '\'' + '}';
  }
=======
	private static final long serialVersionUID = -4330607167106242987L;
	private final long statusId;
	...
	/* package */HttpParameter[] asHttpParameterArray() {
		...
		params.add(new HttpParameter("align", align.name().toLowerCase()));
		if (related.length > 0) {
			appendParameter("related", z_T4JInternalStringUtil.join(related),
					params);
		}
		appendParameter("lang", lang, params);
		HttpParameter[] paramArray = new HttpParameter[params.size()];
	...
	@Override
	public String toString() {
		return "OEmbedRequest{" + "statusId=" + statusId + ", url='" + url
				+ '\'' + ", maxWidth=" + maxWidth + ", hideMedia=" + hideMedia
				+ ", hideThread=" + hideThread + ", omitScript=" + omitScript
				+ ", align=" + align + ", related="
				+ (related == null ? null : Arrays.asList(related))
				+ ", lang='" + lang + '\'' + '}';
	}
