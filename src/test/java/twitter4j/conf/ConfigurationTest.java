/*
 * Copyright (C) 2007 Yusuke Yamamoto Copyright (C) 2011 Twitter, Inc.
 * 
...
public class ConfigurationTest extends TestCase {
  ...
  public void testConfiguration() throws Exception {
    ...
    conf = new PropertyConfiguration();
    assertEquals("http://twitter4j.org/en/twitter4j-" + Version.getVersion() + ".xml",
        conf.getClientURL());
  ...
  public void testConfigurationBuilder() throws Exception {
    ...
    // TFJ-328 RequestToken.getAuthenticationURL()/getAuthorizationURL() should return URLs starting
    // with https:// for security reasons
